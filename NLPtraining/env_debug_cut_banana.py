...
# obj= p.loadURDF('./model/task_cut/obj/banana/banana.urdf', [0.1, 0, 0.01], p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=False) 

knife = p.loadURDF('./model/task_cut/obj/knife/knife.urdf', [-0.075, 0, 0.05], p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=False) 

obj_l= p.loadURDF('./model/task_cut/obj/banana/banana_left.urdf', [0.1, 0, 0.05], p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=True) 
obj_r= p.loadURDF('./model/task_cut/obj/banana/banana_right.urdf', [0.1, 0, 0.05], p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=False) 
