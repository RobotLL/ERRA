...
def build_pick_sth_into_drawer_env(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 1
    ...
    if case_id == 1:  # Low level command:
        ...
        if obj_random == False:
            ...
            obj_x = -0.1 + (random.random()*2-1)*0.01
            obj_y = 0 + (random.random()*2-1)*0.01
            obj_z = 0.01
            obj_roll = 0
            obj_pitch = 0
            obj_yaw = 0 + (random.random()*2-1)*3.14/4
    ...
    return case_id, object_name, obj_id_list, tactile, knife_id, drawer_down


def build_cut_sth_env(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 7
    if force_case_id is not None:
        case_id = force_case_id
...
def build_clean_table_env(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 9
    if force_case_id is not None:
        case_id = force_case_id
    object_name = None
    knife_id = None
    ...
    object_drop_position_lists = [[-0.06, 0], [-0.14, -0.06], [-0.14, 0.06]]
    object_list = ['bottle', 'can', 'chips']

    if case_id == 9:  # Low level command:
        tactile = 0
        drop_x_objects = random.randint(1, 3) if obj_random else 1
        object_names = random.choices(object_list, k=drop_x_objects) if obj_random else object_list
        object_drop_positions = random.sample(object_drop_position_lists, k=drop_x_objects) if obj_random else object_drop_position_lists
        for i in range(drop_x_objects):
            # load object
            obj_path = './model/task_clean/obj/' + object_names[i] + '/' + object_names[i] + '.urdf'
            if obj_random == False:
                obj_x = object_drop_positions[i][0]
                obj_y = object_drop_positions[i][1]
                obj_z = 0.01
                obj_roll = 0
                obj_pitch = 0
                obj_yaw = 0
                ...
                obj_x = object_drop_positions[i][0] + (random.random()*2-1)*0.01
                obj_y = object_drop_positions[i][1] + (random.random()*2-1)*0.01
                obj_z = 0.01
                obj_roll = 0
                obj_pitch = 0
                obj_yaw = 0 + (random.random()*2-1)*3.14/4
...
def multi1(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 13
    if force_case_id is not None:
        case_id = force_case_id
    object_name = None
    knife_id = None
    ...
    if case_id == 12:  # Low level command:
        ...
        # load object
        drop_x_objects = random.randint(1, 2) if obj_random else 1
        if drop_x_objects != 0:
            object_names = random.choices(object_list, k=drop_x_objects)
            object_names.append('apple')
            object_drop_positions = random.sample(object_drop_position_lists, k=drop_x_objects+1) if obj_random else object_drop_position_lists
...
# p.connect(p.DIRECT)
# p.connect(p.GUI)
# multi1(obj_random=True, rl=True, force_case_id = 13)
# sim_d, sim_float, mask = render_camera()
# plt.imshow(sim_d)

# close_drawer_grasp_knife_env
def multi2(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 16
    if force_case_id is not None:
        case_id = force_case_id
    object_name = None
    knife_id = None
...
# p.connect(p.DIRECT)
# p.connect(p.GUI)
# multi2(obj_random=True, rl=True, force_case_id = 15)
# sim_d, sim_float, mask = render_camera()
# plt.imshow(sim_d)

# Multi-task3: put the cosmetic into the drawer and clean the table.
def multi3(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    if rl is True:
        case_list = [18, 19, 20, 21, 22, 23, 21, 18]
    else:
    ...
    case_id = random.choice(case_list) if obj_random else 20
    if force_case_id is not None:
        case_id = force_case_id
    object_name = None
    knife_id = None
    ...
    if case_id == 18:  # Low level command:
        ...
        if obj_random is False:
            ...
            obj_x = -0.175 - random.random()*0.0025
            obj_y = 0.05 + random.random()*0.01
            obj_z = 0.01
            obj_roll = 0
            obj_pitch = 0
            obj_yaw = 0 + (random.random()*2-1)*3.14/4
            scale = random.uniform(0.94, 0.96)
        ...
        for i in range(drop_x_objects):
            ...
            if obj_random is False:
                ...
                obj_x = object_drop_positions[i][0] + (random.random()*2-1)*0.015
                obj_y = object_drop_positions[i][1] + (random.random()*2-1)*0.015
                obj_z = 0.01
                obj_roll = 0
                obj_pitch = 0
                obj_yaw = 0 + (random.random()*2-1)*3.14/4
        ...
        for i in range(drop_x_objects):
            ...
            if obj_random is False:
                ...
                obj_x = object_drop_positions[i][0] - random.random()*0.015 
                obj_y = object_drop_positions[i][1] + (random.random()*2-1)*0.015
                obj_z = 0.01
                obj_roll = 0
                obj_pitch = 0
    ...
    if rl is False:
        return case_id, object_name, obj_id_list, tactile, knife_id, clean_task_object_number, drawer_down
    elif rl is True:
        return case_id, object_name, obj_id_list, tactile, knife_id, drawer_down
...
# p.connect(p.DIRECT)
# p.connect(p.GUI)
# multi3(obj_random=True, rl=True, force_case_id = 18)
# sim_d, sim_float, mask = render_camera()
# plt.imshow(sim_d)

# Multi-task4: clean the table and cur the banana.

def multi4(obj_random=True, rl=False, saycan=False, force_case_id=None):
...
# 29: object into two parts
# p.connect(p.GUI)
# multi4(obj_random=True, rl=True, force_case_id=25)
# sim_d, sim_float, mask = render_camera()
# plt.imshow(sim_d)


def build_pick_round_env(obj_random=True, rl=False, saycan=False, force_case_id=None):
    ...
    case_id = random.choice(case_list) if obj_random else 30
    if force_case_id is not None:
        case_id = force_case_id
    object_name = None
    knife_id = None
    ...
    tactile = None
    # todo
    object_drop_position_lists = [[0, 0.08], [0, -0.08], [-0.08, 0.08], [-0.08, -0.08], [-0.16, 0.08], [-0.16, -0.08]]
    if case_id == 30:  # Low level command:
        tactile = 0
        object_drop_positions = random.sample(object_drop_position_lists, k=5) if obj_random else object_drop_position_lists
        for i in range(random.choice([3, 4, 5])):  # 0 1 2 3 4
            # load object
            obj_x = object_drop_positions[i][0] + ((random.random()*2-1)*0.01 if obj_random else 0)
            obj_y = object_drop_positions[i][1] + ((random.random()*2-1)*0.01 if obj_random else 0)
            obj_z = 0.01
            obj_roll = 0
            obj_pitch = 0
            obj_yaw = 0 + (random.random()*2-1)*3.14/4 if obj_random else 0
            if i <= 1:
